...
namespace Module.OpenGL {
    public class GLBindings {
        ...
        public GLBindings(Func<string, IntPtr> getProcAddressFunc) {
            this.GetProcAddressFunc = getProcAddressFunc ?? throw new Exception("ProcAddress is not available.");
            ...
            CreateDelegate(ref glDrawBuffer, "glDrawBuffer");
            CreateDelegate(ref glReadBuffer, "glReadBuffer");
            CreateDelegate(ref glDrawArrays, "glDrawArrays");
            CreateDelegate(ref glDrawElements, "glDrawElements");
            CreateDelegate(ref glDrawElementsInstanced, "glDrawElementsInstanced");
            CreateDelegate(ref glDrawElementsBaseVertex, "glDrawElementsBaseVertex");
        ...
        {
            var addr = this.GetProcAddressFunc(name);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public unsafe delegate void DrawBuffer(GLEnum buf);
        public DrawBuffer glDrawBuffer;
        
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public unsafe delegate void ReadBuffer(GLEnum buf);
        public ReadBuffer glReadBuffer;
        
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public unsafe delegate void DrawArrays(GLEnum mode, int first, int count);
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public unsafe delegate void DrawElementsBaseVertex(GLEnum mode, int count, GLEnum type, IntPtr indices, int amount);
        public DrawElementsBaseVertex glDrawElementsBaseVertex;
